...
# from src.config import settings  # <- pode remover se não usar
...
from src.ml.registry import load_latest_model, make_run_dir, save_artifacts, latest_run_dir as latest_model_run
